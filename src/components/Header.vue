...
<navbar>
	...
	<ul class="nav navbar-nav d-md-down-none">
		<li class="nav-item header-item">
			<router-link tag="div" to='/' style="height:55px;" class="nav-link">
				<p>
					<Icon type="compose" size='22' color="#fff" style="margin-top:4px;"></Icon>
				</p>
		...
		<li class="nav-item header-item">
			<router-link tag="div" to='/home1' style="height:55px;" class="nav-link">
				<p>
					<Icon type="stats-bars" size='22' color="#fff" style="margin-top:4px;"></Icon>
				</p>
		...
		<li class="nav-item header-item">
			<Dropdown>
				<router-link tag="div" to='/' style="height:55px;" class="nav-link">
					<p>
						<Icon type="android-cloud" size='22' color="#fff" style="margin-top:4px;"></Icon>
					</p>
		...
		<li class="nav-item header-item">
			<router-link tag="div" to='/home1' style="height:55px;" class="nav-link">
				<p>
					<Icon type="trophy" size='22' color="#fff" style="margin-top:4px;"></Icon>
				</p>
	...
	<ul class="nav navbar-nav ml-auto">
		<li class="nav-item d-md-down-none">
			<a class="nav-link">
				<Icon type="android-notifications" size="20"></Icon><span class="badge badge-pill badge-danger">5</span>
			</a>
		</li>
...
.app-header.navbar {
	...
	.img-avatar{ width: 40px; height: 40px; border-radius: 40em; margin: 0 10px;}
}
.dropdown-itemp {
	text-align: left;
	font-size: 15px;
